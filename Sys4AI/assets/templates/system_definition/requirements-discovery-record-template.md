...
**Authorized by:** <Explicit project authorization, governance decision ID, or portable transaction ID>
...
**Discovery gate:** system-definition-interview
**Producer authority:** <Explicit project authorization, governance decision ID, or portable transaction ID>
**Discovery registry row:** <artifact-catalog entry>
...
This record is not a canonical requirements baseline unless promoted through the project source-authority process. Canonical PRDs, source catalogs, decision records, approved requirements, and control records outrank this document.
...
|---|---|---|---|
| decision-grilling | Scope or design decision remains unclear. | yes / no / later | OPEN-* |
| domain-grilling-with-docs | Terminology or documentation conflict remains unresolved. | yes / no / later | OPEN-* |

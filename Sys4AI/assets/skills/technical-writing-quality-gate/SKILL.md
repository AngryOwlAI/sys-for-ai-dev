...
description: Review claim-bearing technical prose for source grounding, concrete mechanisms, warning patterns, and pass/repair/block outcomes.
adaptation_status: generalized_product_asset
source_repo: https://github.com/AngryOwlAI/ai-skills-for-sys
source_path: skills/technical-writing-quality-gate
---
...
Review claim-bearing technical prose for source grounding, concrete mechanisms, warning patterns, and pass/repair/block outcomes.

## When to use

Use this skill when a `Sys4AI` project authority requires the `technical_writing_verification` capability and the governing PRD or implementation plan authorizes skill use.

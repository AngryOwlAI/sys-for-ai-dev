...
description: Convert PRDs, specs, issues, or feature briefs into implementation plans and bounded task packets.
adaptation_status: generalized_product_asset
source_repo: https://github.com/AngryOwlAI/ai-skills-for-sys
source_path: skills/prd-to-implementation-plan
---
...
Convert PRDs, specs, issues, or feature briefs into implementation plans and bounded task packets.

## When to use

Use this skill when a `Sys4AI` project authority requires the `implementation_planning` capability and the governing PRD or implementation plan authorizes skill use.

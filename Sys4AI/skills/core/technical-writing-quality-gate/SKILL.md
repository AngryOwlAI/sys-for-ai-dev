...
Use this skill when a `Sys4AI` AgentJob requires the `technical_writing_verification` capability and the governing PRD or implementation plan authorizes skill use.

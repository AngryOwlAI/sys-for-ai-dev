...
Use this skill when a `Sys4AI` AgentJob requires the `implementation_planning` capability and the governing PRD or implementation plan authorizes skill use.

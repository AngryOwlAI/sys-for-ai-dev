...
| registries/artifact_contract_registry.csv | SRC-REG-ARTIFACT-CONTRACTS | artifact_contract_registry | controlled | 31 | implementation_initialization |
| registries/completion_receipt_registry.csv | SRC-REG-COMPLETION-RECEIPTS | completion_receipt_registry | controlled | 61 | control_loop |
...
| registries/control_record_registry.csv | SRC-REG-CONTROL-RECORDS | control_record_registry | controlled | 306 | implementation_initialization |
...
| registries/derivative_registry.csv | SRC-REG-DERIVATIVES | derivative_registry | controlled | 49 | implementation_initialization |
| registries/director_decision_registry.csv | SRC-REG-DIRECTOR-DECISIONS | director_decision_registry | controlled | 47 | control_loop |
...
| registries/evidence_closure_plan_registry.csv | SRC-REG-EVIDENCE-CLOSURE-PLAN | evidence_closure_plan_registry | controlled | 484 | verification_engineer |
...
| registries/handoff_registry.csv | SRC-REG-HANDOFFS | handoff_registry | controlled | 61 | control_loop |
| registries/local_evidence_execution_registry.csv | SRC-REG-LOCAL-EVIDENCE-EXECUTION | local_evidence_execution_registry | controlled | 74 | verification_engineer |
| registries/memory_preflight_receipt_registry.csv | SRC-REG-MEMORY-PREFLIGHT-RECEIPTS | memory_preflight_receipt_registry | controlled | 61 | control_loop |
| registries/object_relationship_registry.csv | SRC-REG-OBJECT-RELATIONSHIPS | object_relationship_registry | controlled | 465 | source_first_memory |
| registries/plan_scope_interpretation_registry.csv | SRC-REG-PLAN-SCOPE-INTERPRETATION | plan_scope_interpretation_registry | controlled | 410 | system_director |
| registries/prd_module_registry.csv | SRC-REG-PRD-MODULES | registry | controlled | 12 | framework_product |
| registries/registry_definition_registry.csv | SRC-REG-REGISTRY-DEFINITIONS | registry | controlled | 27 | registry_governance |
...
| registries/source_registry.csv | SRC-REG-SOURCES | source_registry | controlled | 660 | implementation_initialization |
...
| registries/validation_contract_registry.csv | SRC-REG-VALIDATION-CONTRACTS | validation_contract_registry | controlled | 52 | implementation_initialization |

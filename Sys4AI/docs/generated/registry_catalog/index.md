...
| --- | --- | --- | --- | --- | --- |
| registries/agentjob_registry.csv | SRC-REG-AGENTJOBS | agentjob_registry | controlled | 26 | control_loop |
...
| registries/completion_receipt_registry.csv | SRC-REG-COMPLETION-RECEIPTS | completion_receipt_registry | controlled | 21 | control_loop |
...
| registries/control_record_registry.csv | SRC-REG-CONTROL-RECORDS | control_record_registry | controlled | 118 | implementation_initialization |
...
| registries/director_decision_registry.csv | SRC-REG-DIRECTOR-DECISIONS | director_decision_registry | controlled | 19 | control_loop |
| registries/discovery_record_registry.csv | SRC-REG-DISCOVERY-RECORDS | discovery_record_registry | controlled | 2 | implementation_initialization |
...
| registries/handoff_registry.csv | SRC-REG-HANDOFFS | handoff_registry | controlled | 21 | control_loop |
| registries/memory_preflight_receipt_registry.csv | SRC-REG-MEMORY-PREFLIGHT-RECEIPTS | memory_preflight_receipt_registry | controlled | 21 | control_loop |
| registries/object_relationship_registry.csv | SRC-REG-OBJECT-RELATIONSHIPS | object_relationship_registry | controlled | 27 | source_first_memory |
...
| registries/role_skill_crosswalk.csv | SRC-REG-ROLE-SKILL-CROSSWALK | role_skill_crosswalk | controlled | 46 | implementation_initialization |
...
| registries/skill_registry.csv | SRC-PRODUCT-SKILL-REGISTRY | skill_registry | controlled | 34 | skill_governance |
| registries/source_registry.csv | SRC-REG-SOURCES | source_registry | controlled | 312 | implementation_initialization |

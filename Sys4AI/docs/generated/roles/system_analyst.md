...
- Primary mission: Compatibility analysis role used by current skill manifests
- Primary outputs: `analysis;requirements`
...
- Required skills: `decision-grilling;source-first-memory`

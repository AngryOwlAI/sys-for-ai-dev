...
## yaml / independent_evaluation_protocol

| contract_id | path | dialect | target_format | target_artifact_type | target_glob | validator_command | owner | authority_status | supersedes | source_hash | generator_version | generation_timestamp | stale_or_orphan_status | known_limitations |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| contract_independent_evaluation_protocol | schemas/contracts/independent_evaluation_protocol.schema.json | 2020-12 | yaml | independent_evaluation_protocol | assurance/independent_evaluation_protocol_tx37.yaml | Sys4AI validate-independent-evaluation | verification_engineer | controlled | pending | pending | sys_for_ai.derivatives.validation_contracts_catalog:0.2.0 | 2026-07-12T14:24:41Z | current | structural conformance only; semantic and acceptance review remain separate |
...
| contract_completion_receipt_v1_0 | registries/control_record_registry.csv | ctrl_strategic_baseline_tx37_completion | control_records/completions/RECEIPT-SFADEV-STRATEGIC-BASELINE-TX37-001.yaml | completion_receipt |
| contract_completion_receipt_v1_0 | registries/control_record_registry.csv | ctrl_strategic_baseline_tx38_completion | control_records/completions/RECEIPT-SFADEV-STRATEGIC-BASELINE-TX38-001.yaml | completion_receipt |
| contract_completion_receipt_v1_0 | registries/control_record_registry.csv | ctrl_strategic_baseline_tx39_completion | control_records/completions/RECEIPT-SFADEV-STRATEGIC-BASELINE-TX39-001.yaml | completion_receipt |
| contract_completion_receipt_v1_0 | registries/control_record_registry.csv | ctrl_strategic_baseline_tx40_completion | control_records/completions/RECEIPT-SFADEV-STRATEGIC-BASELINE-TX40-001.yaml | completion_receipt |
| contract_completion_receipt_v1_0 | registries/control_record_registry.csv | ctrl_strategic_baseline_tx41_completion | control_records/completions/RECEIPT-SFADEV-STRATEGIC-BASELINE-TX41-001.yaml | completion_receipt |
...
| contract_director_decision | registries/control_record_registry.csv | ctrl_strategic_baseline_g10_002_decision | control_records/director_decisions/DDR-SFADEV-STRATEGIC-BASELINE-G10-002.yaml | director_decision |
| contract_director_decision | registries/control_record_registry.csv | ctrl_strategic_baseline_g10_003_decision | control_records/director_decisions/DDR-SFADEV-STRATEGIC-BASELINE-G10-003.yaml | director_decision |
...
| contract_director_decision | registries/control_record_registry.csv | ctrl_strategic_baseline_g11_016_decision | control_records/director_decisions/DDR-SFADEV-STRATEGIC-BASELINE-G11-016.yaml | director_decision |
...
| contract_director_decision | registries/control_record_registry.csv | ctrl_strategic_baseline_g11_independent_evaluation_future_work_decision | control_records/director_decisions/DDR-SFADEV-STRATEGIC-BASELINE-G11-015.yaml | director_decision |
| contract_director_decision | registries/control_record_registry.csv | ctrl_strategic_baseline_g11_independent_evaluation_protocol_decision | control_records/director_decisions/DDR-SFADEV-STRATEGIC-BASELINE-G11-014.yaml | director_decision |
...
| contract_execution_transaction | registries/control_record_registry.csv | ctrl_strategic_baseline_tx37_execution_transaction | control_records/execution_transactions/TX-37-INDEPENDENT-ROTATED-EVALUATION-PROTOCOL.yaml | execution_transaction |
| contract_execution_transaction | registries/control_record_registry.csv | ctrl_strategic_baseline_tx38_execution_transaction | control_records/execution_transactions/TX-38-INDEPENDENT-EVALUATION-FUTURE-WORK-DISPOSITION.yaml | execution_transaction |
| contract_execution_transaction | registries/control_record_registry.csv | ctrl_strategic_baseline_tx39_execution_transaction | control_records/execution_transactions/TX-39-REMAINING-EVIDENCE-FAMILIES-FUTURE-WORK-DISPOSITION.yaml | execution_transaction |
| contract_execution_transaction | registries/control_record_registry.csv | ctrl_strategic_baseline_tx40_execution_transaction | control_records/execution_transactions/TX-40-G10-ACCOUNTABLE-RECONSIDERATION.yaml | execution_transaction |
| contract_execution_transaction | registries/control_record_registry.csv | ctrl_strategic_baseline_tx41_execution_transaction | control_records/execution_transactions/TX-41-G10-ACCOUNTABLE-ACCEPTANCE.yaml | execution_transaction |
...
| contract_handoff_v1_0 | registries/control_record_registry.csv | ctrl_strategic_baseline_tx37_handoff | control_records/handoffs/HANDOFF-SFADEV-STRATEGIC-BASELINE-TX37-001.yaml | handoff |
| contract_handoff_v1_0 | registries/control_record_registry.csv | ctrl_strategic_baseline_tx38_handoff | control_records/handoffs/HANDOFF-SFADEV-STRATEGIC-BASELINE-TX38-001.yaml | handoff |
| contract_handoff_v1_0 | registries/control_record_registry.csv | ctrl_strategic_baseline_tx39_handoff | control_records/handoffs/HANDOFF-SFADEV-STRATEGIC-BASELINE-TX39-001.yaml | handoff |
| contract_handoff_v1_0 | registries/control_record_registry.csv | ctrl_strategic_baseline_tx40_handoff | control_records/handoffs/HANDOFF-SFADEV-STRATEGIC-BASELINE-TX40-001.yaml | handoff |
| contract_handoff_v1_0 | registries/control_record_registry.csv | ctrl_strategic_baseline_tx41_handoff | control_records/handoffs/HANDOFF-SFADEV-STRATEGIC-BASELINE-TX41-001.yaml | handoff |
...
| contract_memory_preflight_receipt | registries/control_record_registry.csv | ctrl_strategic_baseline_tx37_memory_preflight | control_records/memory_preflights/MEMPREFLIGHT-TX-37-INDEPENDENT-ROTATED-EVALUATION-PROTOCOL-20260712T163604Z.yaml | memory_preflight_receipt |
| contract_memory_preflight_receipt | registries/control_record_registry.csv | ctrl_strategic_baseline_tx38_memory_preflight | control_records/memory_preflights/MEMPREFLIGHT-TX-38-INDEPENDENT-EVALUATION-FUTURE-WORK-DISPOSITION-20260712T193912Z.yaml | memory_preflight_receipt |
| contract_memory_preflight_receipt | registries/control_record_registry.csv | ctrl_strategic_baseline_tx39_memory_preflight | control_records/memory_preflights/MEMPREFLIGHT-TX-39-REMAINING-EVIDENCE-FAMILIES-FUTURE-WORK-DISPOSITION-20260712T200220Z.yaml | memory_preflight_receipt |
| contract_memory_preflight_receipt | registries/control_record_registry.csv | ctrl_strategic_baseline_tx40_memory_preflight | control_records/memory_preflights/MEMPREFLIGHT-TX-40-G10-ACCOUNTABLE-RECONSIDERATION-20260712T203155Z.yaml | memory_preflight_receipt |
| contract_memory_preflight_receipt | registries/control_record_registry.csv | ctrl_strategic_baseline_tx41_memory_preflight | control_records/memory_preflights/MEMPREFLIGHT-TX-41-G10-ACCOUNTABLE-ACCEPTANCE-20260712T204730Z.yaml | memory_preflight_receipt |

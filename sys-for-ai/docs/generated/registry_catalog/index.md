...
| --- | --- | --- | --- | --- | --- |
| registries/agentjob_registry.csv | SRC-REG-AGENTJOBS | agentjob_registry | controlled | 15 | control_loop |
...
| registries/completion_receipt_registry.csv | SRC-REG-COMPLETION-RECEIPTS | completion_receipt_registry | controlled | 11 | control_loop |
| registries/config_source_registry.csv | SRC-REG-CONFIG-SOURCES | config_source_registry | controlled | 3 | implementation_initialization |
| registries/control_record_registry.csv | SRC-REG-CONTROL-RECORDS | control_record_registry | controlled | 67 | implementation_initialization |
...
| registries/director_decision_registry.csv | SRC-REG-DIRECTOR-DECISIONS | director_decision_registry | controlled | 9 | control_loop |
| registries/discovery_record_registry.csv | SRC-REG-DISCOVERY-RECORDS | discovery_record_registry | controlled | 0 | implementation_initialization |
...
| registries/handoff_registry.csv | SRC-REG-HANDOFFS | handoff_registry | controlled | 11 | control_loop |
| registries/memory_preflight_receipt_registry.csv | SRC-REG-MEMORY-PREFLIGHT-RECEIPTS | memory_preflight_receipt_registry | controlled | 11 | control_loop |
| registries/object_relationship_registry.csv | SRC-REG-OBJECT-RELATIONSHIPS | object_relationship_registry | controlled | 22 | source_first_memory |
| registries/requirement_trace_registry.csv | SRC-REG-REQ-TRACE | requirement_trace_registry | controlled | 183 | implementation_initialization |
...
| registries/skill_registry.csv | SRC-PRODUCT-SKILL-REGISTRY | skill_registry | controlled | 33 | skill_governance |
| registries/source_registry.csv | SRC-REG-SOURCES | source_registry | controlled | 234 | implementation_initialization |
...
| registries/validation_contract_registry.csv | SRC-REG-VALIDATION-CONTRACTS | validation_contract_registry | controlled | 31 | implementation_initialization |

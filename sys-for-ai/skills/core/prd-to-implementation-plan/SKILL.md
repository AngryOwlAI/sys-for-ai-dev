...
Use this skill when a `sys-for-ai` AgentJob requires the `implementation_planning` capability and the governing PRD or implementation plan authorizes skill use.

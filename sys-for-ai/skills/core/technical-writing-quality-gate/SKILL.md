...
Use this skill when a `sys-for-ai` AgentJob requires the `technical_writing_verification` capability and the governing PRD or implementation plan authorizes skill use.

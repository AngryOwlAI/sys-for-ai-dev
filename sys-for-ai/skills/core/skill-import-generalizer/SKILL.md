...
description: Convert project-specific skills into reusable templates and maintain import/adaptation boundaries.
adaptation_status: adapter_shell
source_repo: https://github.com/AngryOwlAI/ai-skills-for-sys
source_path: .codex/skills/skill-import-generalizer
---
...
Convert project-specific skills into reusable templates and maintain import/adaptation boundaries.

## When to use

Use this skill when a `sys-for-ai` AgentJob requires the `skill_library_maintenance` capability and the governing PRD or implementation plan authorizes skill use.

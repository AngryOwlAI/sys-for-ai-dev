...
Use this skill when a `sys-for-ai` AgentJob requires the `domain_documentation_clarification` capability and the governing PRD or implementation plan authorizes skill use.

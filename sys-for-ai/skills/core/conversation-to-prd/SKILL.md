...
Use this skill when a `sys-for-ai` AgentJob requires the `requirements_production` capability and the governing PRD or implementation plan authorizes skill use.

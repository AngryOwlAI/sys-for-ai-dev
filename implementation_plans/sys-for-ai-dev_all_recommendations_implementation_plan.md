# sys-for-ai-dev Implementation Plan: Full Integration of Discovery Gate, Self-Hosting Governance, Role Validation, Runtime Skill Reconciliation, and Core Skill Expansion

**Plan ID:** `SFADEV-IMPL-PLAN-ALL-RECS-001`
**Status:** Draft for maintainer review
**Prepared for repository:** `AngryOwlAI/sys-for-ai-dev`
**Prepared date:** 2026-07-07
**Primary subject system:** `sys-for-ai-dev` development workspace
**Framework product under development:** `sys-for-ai`
...
This implementation plan converts the review recommendations into a concrete, staged roadmap for `sys-for-ai-dev`.
...
|---|---|---|---|---|
| `development_system` | `sys-for-ai-dev` | The current development workspace and active operating layer used to build `sys-for-ai`. | repository root, `.agents/`, `.codex/`, root `Makefile`, root scripts | Active runtime authority for development. |
| `framework_product` | `sys-for-ai` | The product framework being developed. | `sys-for-ai/`, `PRDs/`, `implementation_plans/` | Product scaffold and reference implementation. |
| `target_system_template` | Future generated system template | Generic templates, patterns, contracts, and examples used by `sys-for-ai` to create future target systems. | `sys-for-ai/templates/`, some `sys-for-ai/skills/core/` content | Template authority only when explicitly classified. |
| `target_system_instance` | A concrete future target system | A system produced or managed by `sys-for-ai`. | future generated repo or package | Project-specific authority; must not mutate core framework authority without escalation. |
...
6. **Runtime and scaffold are different.** `.agents/skills/` is the active runtime surface for `sys-for-ai-dev`; `sys-for-ai/skills/core/` is the product scaffold/reference surface unless promoted.
...
| Add new core skills | WS-07 through WS-13 | `.agents/skills/*`, `sys-for-ai/skills/core/*`, registries | `validate-dev-skills`, `validate-skills`, role validation | all new core skill manifests pass |
...
3. Confirm `sys-for-ai/Makefile` aggregate validation behavior.
4. Confirm `.agents/skill_registry/SKILL_REGISTRY.yaml` content.
5. Confirm `sys-for-ai/skills/core_skill_manifest.yaml` content.
...
`SFA-P1-INIT-CORESKILL-004`: Product-scaffold adapter surfaces shall be added under `sys-for-ai/skills/core/<skill-id>/` for each active core skill.
...
```text
sys-for-ai/registries/system_layer_registry.csv
sys-for-ai/registries/discovery_record_registry.csv
sys-for-ai/registries/role_registry.csv
sys-for-ai/registries/role_skill_crosswalk.csv
sys-for-ai/registries/role_execution_binding_registry.csv
sys-for-ai/registries/artifact_contract_registry.csv
sys-for-ai/registries/core_skill_proposal_registry.csv
sys-for-ai/registries/skill_lifecycle_status_registry.csv

sys-for-ai/schemas/contracts/system_layer_registry_row.schema.json
sys-for-ai/schemas/contracts/discovery_record_registry_row.schema.json
sys-for-ai/schemas/contracts/role_registry_row.schema.json
sys-for-ai/schemas/contracts/role_skill_crosswalk_row.schema.json
sys-for-ai/schemas/contracts/role_execution_binding_registry_row.schema.json
sys-for-ai/schemas/contracts/artifact_contract_registry_row.schema.json
sys-for-ai/schemas/contracts/core_skill_proposal_registry_row.schema.json
sys-for-ai/schemas/contracts/skill_lifecycle_status_registry_row.schema.json
```
...
```csv
development_system,sys-for-ai-dev,development_system,".;.agents;.codex;scripts;PRDs;implementation_plans",".;.agents;.codex;scripts;PRDs;implementation_plans","docs/generated;.local",Active development workspace authority,true,"make validate-dev-skills;make validate-product-scaffold",system_director,,,
framework_product,sys-for-ai,framework_product,"sys-for-ai;PRDs;implementation_plans","sys-for-ai;PRDs;implementation_plans","sys-for-ai/docs/generated",Product framework scaffold authority,true,"cd sys-for-ai && make validate",system_director,,,
target_system_template,Target system template,target_system_template,"sys-for-ai/templates;sys-for-ai/skills/core","sys-for-ai/templates;sys-for-ai/skills/core","sys-for-ai/docs/generated",Template authority only,true,"cd sys-for-ai && make validate",system_architect,,,
...
derivative_surface,Generated derivative surface,derivative_surface,"docs/generated;sys-for-ai/docs/generated","","docs/generated;sys-for-ai/docs/generated",Non-canonical by default,true,"validate-generated-derivatives",documentation_librarian,,,
```
...
sys-for-ai/skills/core/system-definition-interview-context-45/SKILL.md
sys-for-ai/skills/core/system-definition-interview-context-45/README.md
sys-for-ai/skills/core/system-definition-interview-context-45/AGENTS.md
sys-for-ai/templates/system_definition/requirements-discovery-record-template.md
sys-for-ai/schemas/discovery_record.schema.yaml
sys-for-ai/sys_for_ai/discovery.py
sys-for-ai/sys_for_ai/cli.py
sys-for-ai/Makefile
sys-for-ai/registries/discovery_record_registry.csv
sys-for-ai/registries/artifact_contract_registry.csv
...
Modify `sys-for-ai/sys_for_ai/discovery.py`:
...
```text
sys-for-ai/control_records/agentjobs/AJ-P1-DISCOVERY-GATE-SMOKE-001.yaml
```
...
subject_system_id: sys-for-ai
subject_layer: framework_product
allowed_reads:
  - PRDs/**
  - sys-for-ai/templates/system_definition/**
  - .agents/skills/system-definition-interview-context-45/**
allowed_writes:
  - sys-for-ai/control_records/system_definition/**
  - sys-for-ai/registries/discovery_record_registry.csv
forbidden_actions:
...
sys-for-ai/schemas/contracts/role_skill_crosswalk_row.schema.json
sys-for-ai/schemas/contracts/role_execution_binding_registry_row.schema.json
sys-for-ai/sys_for_ai/roles.py
sys-for-ai/sys_for_ai/role_validators.py
sys-for-ai/sys_for_ai/cli.py
sys-for-ai/sys_for_ai/validators.py
sys-for-ai/Makefile
sys-for-ai/docs/generated/roles/README.md
sys-for-ai/docs/generated/roles/<role-id>.md
...
```text
sys-for-ai/docs/generated/roles/README.md
sys-for-ai/docs/generated/roles/system_director.md
...
```
...
3. If lifecycle is `product_scaffold_reference`, path should be under `sys-for-ai/skills/core` or equivalent scaffold root.
...
sys-for-ai/skills/core/<skill-id>/SKILL.md
sys-for-ai/skills/core/<skill-id>/README.md
sys-for-ai/skills/core/<skill-id>/AGENTS.md
sys-for-ai/skills/core/<skill-id>/examples/portable-example.md
```
...
Implement a core skill and policy layer that prevents confusion between `sys-for-ai-dev`, `sys-for-ai`, future target-system templates, future target-system instances, and generated derivatives.

### 12.2 Files to Add or Modify

```text
.agents/skills/system-layer-classifier/*
sys-for-ai/skills/core/system-layer-classifier/*
sys-for-ai/docs/self_hosting_mode_policy.md
sys-for-ai/configs/self_hosting_mode.toml
sys-for-ai/registries/system_layer_registry.csv
sys-for-ai/registries/config_source_registry.csv
sys-for-ai/schemas/contracts/self_hosting_mode.schema.json
sys-for-ai/sys_for_ai/system_layers.py
sys-for-ai/sys_for_ai/cli.py
sys-for-ai/Makefile
```
...
product_scaffold = ["sys-for-ai"]
derivative_roots = ["docs/generated", "sys-for-ai/docs/generated"]
...
sys-for-ai/skills/core/artifact-contract-governance/*
sys-for-ai/registries/artifact_contract_registry.csv
sys-for-ai/schemas/contracts/artifact_contract_registry_row.schema.json
sys-for-ai/sys_for_ai/artifact_contracts.py
sys-for-ai/sys_for_ai/cli.py
sys-for-ai/Makefile
sys-for-ai/templates/artifacts/*
```
...
sys-for-ai/skills/core/traceability-matrix-engine/*
sys-for-ai/registries/requirement_trace_registry.csv
sys-for-ai/registries/object_relationship_registry.csv
sys-for-ai/registries/artifact_contract_registry.csv
sys-for-ai/sys_for_ai/traceability.py
sys-for-ai/sys_for_ai/cli.py
sys-for-ai/Makefile
sys-for-ai/templates/traceability/traceability-ledger-template.md
```
...
```text
sys-for-ai/registries/traceability_edge_registry.csv
```
...
sys-for-ai/skills/core/director-decision-governor/*
sys-for-ai/control_records/director_decisions/*.yaml
sys-for-ai/registries/director_decision_registry.csv
sys-for-ai/schemas/contracts/director_decision.schema.json
sys-for-ai/sys_for_ai/control_loop.py
sys-for-ai/sys_for_ai/validators.py
```
...
```text
sys-for-ai/templates/control_records/director_decision_template.yaml
```
...
sys-for-ai/docs/generated/validation_contracts/*
sys-for-ai/docs/generated/roles/*
sys-for-ai/docs/generated/artifact_contracts/*
sys-for-ai/docs/generated/system_layers/*
sys-for-ai/docs/generated/core_skills/*
sys-for-ai/registries/derivative_registry.csv
sys-for-ai/sys_for_ai/derivatives.py
...
subject_system_id: sys-for-ai-dev
...
allowed_writes:
  - .agents/skills/system-definition-interview-context-45/**
  - sys-for-ai/skills/core/system-definition-interview-context-45/**
  - sys-for-ai/templates/system_definition/**
  - sys-for-ai/sys_for_ai/discovery.py
  - sys-for-ai/registries/discovery_record_registry.csv
forbidden_actions:
...
allowed_writes:
  ...
  - sys-for-ai/registries/role_skill_crosswalk.csv
  - sys-for-ai/registries/role_execution_binding_registry.csv
  - sys-for-ai/schemas/contracts/role*.schema.json
  - sys-for-ai/sys_for_ai/roles.py
  - sys-for-ai/sys_for_ai/role_validators.py
  - sys-for-ai/sys_for_ai/cli.py
  - sys-for-ai/Makefile
...
```text
PRDs/
  sys-for-ai_phase-0_product_system_design_prd.md        # modify
  sys-for-ai_phase-1_implementation_initialization_prd.md # modify

implementation_plans/
  sys-for-ai-dev_all_recommendations_implementation_plan.md # this plan
...
| RISK-005 | Product scaffold and active runtime registries drift. | High | Medium | Add cross-registry validation between `.agents` and `sys-for-ai/skills/core_skill_manifest.yaml`. | Skill Governance Agent |
...
| Product scaffold | `cd sys-for-ai && make validate` | Validates product scaffold registries, contracts, control records, generated docs. |
...
- Work could affect `sys-for-ai-dev`, `sys-for-ai`, or target-system templates.
...
In short: `sys-for-ai-dev` becomes a governed system for developing `sys-for-ai`, and `sys-for-ai` becomes a governed system for developing future systems.

# Sys4AI-dev Self-Hosting Memory and `/continue` Implementation Plan

**Document status:** Proposed implementation plan
**Prepared for:** `AngryOwlAI/Sys4AI-dev`
**Target implementation area:** `Sys4AI/` inside `Sys4AI-dev`
...
The plan assumes the current `Sys4AI-dev` repository state in which:

- `PRDs/Sys4AI_phase-0_product_system_design_prd.md` is the canonical Phase 0 product and system-design baseline.
- `PRDs/Sys4AI_phase-1_implementation_initialization_prd.md` is the Phase 1 implementation initialization baseline.
- The product implementation scaffold lives under `Sys4AI/`.
...
```text
Sys4AI-dev is the development system.
Sys4AI is the product being developed inside Sys4AI-dev.
Sys4AI is itself a framework for developing systems.
Sys4AI-dev is therefore the first serious dogfood target for Sys4AI concepts.
```
...
The plan implements two core capabilities inside `Sys4AI/`:
...
Sys4AI-dev/
  README.md
  PRDs/
    Sys4AI_phase-0_product_system_design_prd.md
    Sys4AI_phase-1_implementation_initialization_prd.md
    Sys4AI_phase-0_prd.md
...
The `Sys4AI/` scaffold already contains the early implementation spine:
...
```text
Sys4AI/control_records/examples/phase1_smoke_agentjob.yaml
...
Sys4AI/schemas/contracts/handoff.schema.json
Sys4AI/schemas/contracts/completion_receipt.schema.json
Sys4AI/schemas/contracts/state_snapshot.schema.json
Sys4AI/schemas/contracts/sys4ai_config.schema.json
Sys4AI/schemas/contracts/target_project_config.schema.json
Sys4AI/schemas/contracts/format_profile_registry_row.schema.json
Sys4AI/schemas/contracts/config_source_registry_row.schema.json
Sys4AI/schemas/contracts/control_record_registry_row.schema.json
Sys4AI/schemas/contracts/validation_contract_registry_row.schema.json
Sys4AI/schemas/contracts/registry_header.schema.json
...
7. Hardcode Codex as the only possible execution harness for `Sys4AI`.
...
Sys4AI/wiki/                       # optional later
Sys4AI/.local/memory/              # ignored
Sys4AI/.local/obsidian/            # ignored, optional
Sys4AI/.local/search_index/        # ignored
Sys4AI/.local/receipts/            # ignored unless promoted
```
...
Capture the current `Sys4AI-dev` and `Sys4AI/` state before introducing the self-hosting memory and `/continue` kernel.

### 10.2 Deliverables

```text
implementation_plans/current_state_baseline_self_hosting_memory_continue.md
Sys4AI/.local/receipts/baseline-inspection.txt     # local ignored receipt
```
...
2. Inspect existing `Sys4AI/README.md`.
...
Make the self-referential development state explicit so `Sys4AI-dev` can dogfood `Sys4AI` concepts without confusing product requirements, product implementation, development runtime skills, generated derivatives, and local retrieval surfaces.
...
Sys4AI/docs/memory_retrieval_policy.md
Sys4AI/docs/continue_loop_policy.md
Sys4AI/control_records/program_state.yaml
Sys4AI/schemas/contracts/program_state.schema.json
```
...
Create `Sys4AI/control_records/program_state.yaml`:
...
```text
system_context.framework_system == Sys4AI
system_context.development_system == Sys4AI-dev
...
```csv
ctrl_program_state,control_records/program_state.yaml,program_state,controlled,control_loop,contract_program_state,control_loop_engineer;system_director,all_agents,,,pending,pending,Current tracked continuation state for Sys4AI self-hosting implementation
```

Add to `validation_contract_registry.csv`:

```csv
contract_program_state,schemas/contracts/program_state.schema.json,2020-12,yaml,program_state,control_records/program_state.yaml,controlled,control_loop,Sys4AI validate-program-state,,pending,pending,Validates tracked /continue program state
```
...
Sys4AI/schemas/contracts/handoff_v0_2.schema.json
Sys4AI/schemas/contracts/completion_receipt_v0_2.schema.json
Sys4AI/schemas/contracts/memory_preflight_receipt.schema.json
Sys4AI/schemas/contracts/agentjob_registry_row.schema.json
Sys4AI/schemas/contracts/director_decision_registry_row.schema.json
Sys4AI/schemas/contracts/handoff_registry_row.schema.json
Sys4AI/schemas/contracts/completion_receipt_registry_row.schema.json
Sys4AI/schemas/contracts/memory_preflight_receipt_registry_row.schema.json
...
```text
Sys4AI/sys_for_ai/memory/__init__.py
Sys4AI/sys_for_ai/memory/model.py
Sys4AI/sys_for_ai/memory/registry_catalog.py
Sys4AI/sys_for_ai/memory/authority.py
Sys4AI/sys_for_ai/memory/hashing.py
Sys4AI/sys_for_ai/memory/lookup.py
Sys4AI/sys_for_ai/memory/search.py
Sys4AI/sys_for_ai/memory/graph.py
Sys4AI/sys_for_ai/memory/bootstrap.py
Sys4AI/tests/test_memory_lookup.py
Sys4AI/tests/test_memory_search.py
```
...
python -m sys_for_ai.cli memory lookup PRDs/Sys4AI_phase-0_product_system_design_prd.md --json
```
...
```bash
python -m sys_for_ai.cli memory hash-path Sys4AI/README.md --json
...
```text
Sys4AI/sys_for_ai/memory/preflight.py
Sys4AI/sys_for_ai/memory/receipts.py
Sys4AI/control_records/memory_preflights/memory_preflight_receipt.example.yaml
Sys4AI/schemas/contracts/memory_preflight_receipt.schema.json
Sys4AI/tests/test_memory_preflight.py
```
...
```text
Sys4AI/sys_for_ai/control_loop/__init__.py
Sys4AI/sys_for_ai/control_loop/model.py
Sys4AI/sys_for_ai/control_loop/state.py
Sys4AI/sys_for_ai/control_loop/director.py
Sys4AI/sys_for_ai/control_loop/job_selection.py
Sys4AI/sys_for_ai/control_loop/execution_packet.py
Sys4AI/sys_for_ai/control_loop/handoff.py
Sys4AI/sys_for_ai/control_loop/validators.py
...
```text
Sys4AI/sys_for_ai/control_loop/finalization.py
Sys4AI/sys_for_ai/control_loop/receipts.py
Sys4AI/sys_for_ai/control_loop/handoff.py
...
Sys4AI/tests/test_completion_chain.py
Sys4AI/tests/test_handoff_chain.py
```
...
```text
Sys4AI/sys_for_ai/control_loop/boundaries.py
...
The validator should support running from either repository root or `Sys4AI/` root.
...
- Validator works from repo root and `Sys4AI/` root.
...
```text
Sys4AI/sys_for_ai/derivatives/config_control_wiki.py
Sys4AI/sys_for_ai/derivatives/validation_contracts_catalog.py
Sys4AI/sys_for_ai/derivatives/templates.py
...
Sys4AI/docs/skill_integration_policy.md updates if needed
Sys4AI/registries/skill_registry.csv updates
Sys4AI/skills/core_skill_manifest.yaml updates if required
```
...
---
name: continue
description: Codex compatibility shim for the Sys4AI-dev /continue skill.
---
...
`Sys4AI/skills/core/continue/SKILL.md` should be portable and target-system oriented:

```markdown
---
name: continue
description: Generic target-system continuation skill template for Sys4AI generated systems.
---

# Generic /continue

A target system generated by Sys4AI may adapt this skill to resume from tracked state, inspect the latest handoff, run memory preflight, select at most one bounded AgentJob, validate completion, and create a new handoff.
...
```text
Sys4AI/tests/ updated
Sys4AI/registries/requirement_trace_registry.csv updated
Sys4AI/docs/generated/ refreshed
...
3. Add product scaffold skills under `Sys4AI/skills/core/` only if the skill manifest is updated accordingly.
...
objective: >
  ...
  kernel for Sys4AI-dev using source-first memory, tracked program state,
...
forbidden_actions:
  ...
  - Hardcode Codex as the only supported Sys4AI harness.
...
validators:
  ...
  - cd Sys4AI && make validate
  - cd Sys4AI && python -m sys_for_ai.cli continue-status --json
  - cd Sys4AI && python -m sys_for_ai.cli continue-packet --json
completion_evidence_required:
  - memory_preflight_receipt_id
  - changed_artifacts
  - command_results
...
This implementation is done when the following command chain passes from `Sys4AI/`:
...
Once that works, `Sys4AI-dev` becomes a disciplined self-hosting development system rather than a recursive fog machine.

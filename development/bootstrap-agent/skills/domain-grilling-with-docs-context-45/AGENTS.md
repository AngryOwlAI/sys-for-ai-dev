...
Canonical runtime path: `development/bootstrap-agent/skills/domain-grilling-with-docs-context-45`
...
Maintain `domain-grilling-with-docs-context-45` as a reusable long-session
template skill. It should preserve the portable documentation-aware grilling
workflow while adding context-window checkpoints and resumable `temp_prd.md`
handoff behavior.

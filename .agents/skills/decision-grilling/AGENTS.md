...
Maintain `decision-grilling` as a reusable template skill. It should define the portable capability without depending on the source project that inspired it.

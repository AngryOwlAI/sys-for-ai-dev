...
Use this skill when an AgentJob needs to create, review, validate, or repair controlled role definitions, role-to-skill crosswalk rows, or role execution bindings.
...
4. Verify temporary role bindings declare expiry and do not outlive their AgentJob.

...
**Owns requirement prefixes:** SFA-CORE-AJ;SFA-CORE-CONT;SFA-P0-FR-017;SFA-P0-FR-018;SFA-P0-RISK-008;SFA-P0-RISK-009;SFA-P1-INIT-YAML
...
Define bounded AgentJob execution, tracked continuation, memory preflight, completion receipts, and handoff routing.
...
- state, handoff, and receipt evidence
- control-record YAML surfaces
- bounded packet selection
...
- Promotion must decide whether YAML control-record format rules remain owned here or move fully to validation and traceability.

...
**References requirement prefixes:** PRD-MOD-ROLE-GOVERNANCE;PRD-MOD-SOURCE-FIRST-MEMORY;PRD-MOD-VALIDATION-TRACEABILITY
...
Define lifecycle status, synchronization, adaptation, deprecation, and runtime/product skill boundaries.
...
- core skill manifest
- runtime skill adaptation
- skill lifecycle status registry
- source-library versus runtime-layer distinction
...
- Promotion should preserve additive skill variants and avoid destructive replacement of in-progress skill surfaces.

...
**Owns requirement prefixes:** SFA-CORE-MEM;SFA-CORE-DOC;SFA-P0-RISK-007;SFA-P0-ISSUE-007;SFA-P0-ISSUE-008;SFA-P1-INIT-MEM
...
Define memory as navigation to registered authority, with stale-context checks, canonical-source inspection, and generated derivative limits.
...
- source registry use
- memory preflight evidence
- retrieval freshness
- derivative authority boundaries
...
- Promotion should confirm which wiki and local-reader surfaces are required first and which remain optional.

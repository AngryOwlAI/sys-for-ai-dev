...
**Owns requirement prefixes:** SFA-CORE-SVC;SFA-P0-FR-020;SFA-P0-FR-021
**References requirement prefixes:** PRD-MOD-AGENTJOB-CONTINUE;PRD-MOD-SOURCE-FIRST-MEMORY;PRD-MOD-ROLE-GOVERNANCE
...
Define Director decisions, completion receipts, handoff interfaces, and integration contracts between agents and controlled artifacts.
...
- decision records
- completion receipt interface
- handoff contract integration
- source/version-control interaction
...
- Promotion should decide how much source/version-control policy stays here versus in validation or operations.

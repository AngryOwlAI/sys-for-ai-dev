...
**Owns requirement prefixes:** SFA-CORE-ROLE;SFA-CORE-ART;SFA-P1-INIT-ROLE
...
Define role catalogs, role-to-skill binding, artifact ownership, responsibilities, and execution boundaries.
...
- registered roles
- artifact producer and consumer expectations
...
- Promotion should decide whether artifact catalog content remains here or splits into a separate artifact-contract module.
